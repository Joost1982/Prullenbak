'''
keep VBA code with openpyxl
(https://stackoverflow.com/questions/17675780/how-to-save-xlsm-file-with-macro-using-openpyxl/41742329#41742329)

NB.
Je kan ook de keep_vba parameter gebruiken:
   wb = load_workbook(filename='1.xlsm', read_only=False, keep_vba=True)
maar dat ging niet goed bij mij en daarom heb ik onderstaande workaround bedacht.
'''
